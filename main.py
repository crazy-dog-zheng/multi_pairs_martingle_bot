...
def get_data(trader: Union[BinanceFutureTrader, BinanceSpotTrader]):
    ...
    for symbol in symbols:
        ...
        #
        #     value = {'pct': pct.iloc[-1], 'pct_4h': pct_4h.iloc[-1], 'symbol': symbol,
        #              'hour_turnover': df['turnover'].iloc[-1]}
        #
        ...
        signals.append({'signal': 1, 'symbol': symbol, 'hour_turnover': 1000000, 'pct': 1, 'pct_4h': 1})
